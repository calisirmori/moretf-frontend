...
export default function TeamPerformancePage({
  ...
  const [metric, setMetric] = useState<(typeof METRICS)[number]>("kills");
  ...
  return (
    <div className="flex-col max-w-7xl text-white bg-light-100/50 dark:bg-warm-800/60  font-ttnorms p-10">
          ...
          <button
            ...
            className={`flex-1 font-medium rounded-sm ${
              metric === m
                ...
                : "text-light-800 bg-warm-700 hover:text-light-100 hover:bg-warm-800"
            }`}
            onClick={() => {
              setMetric(m);
